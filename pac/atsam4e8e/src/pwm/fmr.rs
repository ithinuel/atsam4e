...
#[doc = "Field `FPOL` reader - Fault Polarity (fault input bit varies from 0 to 7)"]
...
#[doc = "Field `FPOL` writer - Fault Polarity (fault input bit varies from 0 to 7)"]
pub struct FPOL_W<'a> {
    w: &'a mut W,
}
impl<'a> FPOL_W<'a> {
...
#[doc = "Field `FMOD` reader - Fault Activation Mode (fault input bit varies from 0 to 7)"]
...
#[doc = "Field `FMOD` writer - Fault Activation Mode (fault input bit varies from 0 to 7)"]
pub struct FMOD_W<'a> {
    w: &'a mut W,
}
impl<'a> FMOD_W<'a> {
...
#[doc = "Field `FFIL` reader - Fault Filtering (fault input bit varies from 0 to 7)"]
...
#[doc = "Field `FFIL` writer - Fault Filtering (fault input bit varies from 0 to 7)"]
pub struct FFIL_W<'a> {
    w: &'a mut W,
}
impl<'a> FFIL_W<'a> {
