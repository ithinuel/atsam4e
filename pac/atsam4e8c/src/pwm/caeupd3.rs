#[doc = "Register `CAEUPD3` writer"]
pub struct W(crate::W<CAEUPD3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAEUPD3_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<CAEUPD3_SPEC>> for W {
    fn from(writer: crate::W<CAEUPD3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PWM Channel Additional Edge Update Register (ch_num = 3)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [caeupd3](index.html) module"]
pub struct CAEUPD3_SPEC;
impl crate::RegisterSpec for CAEUPD3_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [caeupd3::W](W) writer structure"]
impl crate::Writable for CAEUPD3_SPEC {
    type Writer = W;
}
