...
pub struct RegisterBlock {
    ...
    pub wprot_mode: crate::Reg<wprot_mode::WPROT_MODE_SPEC>,
    #[doc = "0xe8 - Protection Status Register"]
    pub wprot_status: crate::Reg<wprot_status::WPROT_STATUS_SPEC>,
...
pub mod thr;
#[doc = "WPROT_MODE register accessor: an alias for `Reg<WPROT_MODE_SPEC>`"]
pub type WPROT_MODE = crate::Reg<wprot_mode::WPROT_MODE_SPEC>;
#[doc = "Protection Mode Register"]
pub mod wprot_mode;
#[doc = "WPROT_STATUS register accessor: an alias for `Reg<WPROT_STATUS_SPEC>`"]
pub type WPROT_STATUS = crate::Reg<wprot_status::WPROT_STATUS_SPEC>;
