...
Received"]
    ...
    pub tsss: crate::Reg<tsss::TSSS_SPEC>,
    ...
    pub efts: crate::Reg<efts::EFTS_SPEC>,
    ...
    pub efrs: crate::Reg<efrs::EFRS_SPEC>,
    ...
    pub pefts: crate::Reg<pefts::PEFTS_SPEC>,
    ...
    pub pefrs: crate::Reg<pefrs::PEFRS_SPEC>,
...
pub mod uce;
#[doc = "TSSS register accessor: an alias for `Reg<TSSS_SPEC>`"]
pub type TSSS = crate::Reg<tsss::TSSS_SPEC>;
...
pub mod tssn;
#[doc = "TS register accessor: an alias for `Reg<TS_SPEC>`"]
pub type TS = crate::Reg<ts::TS_SPEC>;
...
pub mod ti;
#[doc = "EFTS register accessor: an alias for `Reg<EFTS_SPEC>`"]
...
pub mod eftn;
#[doc = "EFRS register accessor: an alias for `Reg<EFRS_SPEC>`"]
...
pub mod efrn;
#[doc = "PEFTS register accessor: an alias for `Reg<PEFTS_SPEC>`"]
...
pub mod peftn;
#[doc = "PEFRS register accessor: an alias for `Reg<PEFRS_SPEC>`"]
