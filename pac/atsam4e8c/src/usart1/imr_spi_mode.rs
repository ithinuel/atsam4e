...
pub struct R(crate::R<IMR_SPI_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IMR_SPI_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<IMR_SPI_MODE_SPEC>> for R {
    fn from(reader: crate::R<IMR_SPI_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [imr_spi_mode](index.html) module"]
pub struct IMR_SPI_MODE_SPEC;
impl crate::RegisterSpec for IMR_SPI_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [imr_spi_mode::R](R) reader structure"]
impl crate::Readable for IMR_SPI_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets IMR_SPI_MODE to value 0"]
impl crate::Resettable for IMR_SPI_MODE_SPEC {
    #[inline(always)]
